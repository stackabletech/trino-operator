...
use stackable_trino_crd::{
    ...
    PASSWORD_AUTHENTICATOR_PROPERTIES, PASSWORD_DB, PW_FILE_CONTENT_MAP_KEY, CERTIFICATE_PEM
};
...
-Djdk.nio.maxCachedBufferSize=2000000"
        ...
        // WIP
        let server_pem = "-----BEGIN PRIVATE KEY-----
        ...
        for (property_name_kind, config) in validated_config {
            ...
            match property_name_kind {
                ...
                PropertyNameKind::File(file_name) if file_name == CERTIFICATE_PEM => {
                    cm_conf_data.insert(file_name.to_string(), server_pem.to_string());
                }
                _ => {}
            }
        }
