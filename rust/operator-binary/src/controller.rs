...
fn create_tls_volume(
    ...
    let mut secret_volume_source_builder = SecretOperatorVolumeSourceBuilder::new(tls_secret_class, SecretClassVolumeProvisionParts::PublicPrivate);
...
fn tls_volume_mounts(
        ...
        })
    {
        ...
        let opa_tls_volume = VolumeBuilder::new(OPA_TLS_VOLUME_NAME)
            .ephemeral(
                SecretOperatorVolumeSourceBuilder::new(tls_secret_class, SecretClassVolumeProvisionParts::PublicPrivate)
                    .build()
                    .context(TlsCertSecretClassVolumeBuildSnafu)?,
            )
            .build();
