// As of 2024-02-07 we support multiple Trino versions. Some using Java 17 and the latest (440) uses Java 21.
...
pub fn jvm_config(
    ...
    // Basically copied from https://trino.io/docs/440/installation/deployment.html and merged
