...
IMPORTANT: Overriding certain properties (such as `http-server.https.port`) which are set by operator can lead to faulty installations.
...
For a list of possible configuration properties see: https://trino.io/docs/current/admin/properties.html
