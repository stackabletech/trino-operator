...
To access the CLI please download the https://repo1.maven.org/maven2/io/trino/trino-cli/387/trino-cli-387-executable.jar[Trino CLI] and execute:
[source]
----
