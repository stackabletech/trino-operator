...
The <user>:<password> combinations are provided in the `stringData` field. Passwords need to be base64 encoded. The hashes are created using bcrypt with 10 rounds or more.
