...
Create an insecure single node Trino (v387) cluster for testing. This can be accessed with the UI/CLI via http without either user/password credentials or authorization.
...
[source,yaml]
----
include::example$code/trino-insecure.yaml[]
----
...
[source,yaml]
----
include::example$code/trino-secure-tls.yaml[]
----
...
[source,yaml]
----
include::example$code/trino-secure-tls-only.yaml[]
----
...
[source,yaml]
----
include::example$code/trino-secure-internal-tls.yaml[]
----
