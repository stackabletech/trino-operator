...
:crd: {crd-docs}/trino.stackable.tech/trinocluster/v1alpha1/
...
This is an operator for Kubernetes that can manage h{trino}[Trino] clusters.
...
It will guide you through the installation process and help you run your first Trino queries on Kubernetes.
...
* The {crd}[TrinoCluster {external-link-icon}^] CRD documentation
