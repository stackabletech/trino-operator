...
In case the Trino operator does not support a specific connector you can use this generic connector to utilize any connector Trino supports.
You are on your own figuring out how to configure and use this connector and we can't possible support all the catalogs available.
